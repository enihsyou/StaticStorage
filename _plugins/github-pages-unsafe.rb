# Restore the original GitHub Pages configuration to allow plugins from `_plugins` folder.
# https://github.com/OpenKneeboard/OpenKneeboard/blob/master/docs/_plugins/github-pages-unsafe.rb
